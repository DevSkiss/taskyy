...
class $AssetsFontsGen {
  ...
  List<String> get values =>
      [poppinsBlack, poppinsBold, poppinsRegular, poppinsSemiBold];
}
...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icon_outline.png
  AssetGenImage get iconOutline =>
      const AssetGenImage('assets/icons/icon_outline.png');

  /// List of all assets
  List<AssetGenImage> get values => [icon, iconOutline];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/create-first-bg.png
  AssetGenImage get createFirstBg =>
      const AssetGenImage('assets/images/create-first-bg.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [createFirstBg, emptyList];
}
